...
#include "IK2/IK2Character.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIK2Character() {}
// Cross Module References
	IK2_API UClass* Z_Construct_UClass_AIK2Character_NoRegister();
...
// End Cross Module References
	void AIK2Character::StaticRegisterNativesAIK2Character()
	{
	}
	UClass* Z_Construct_UClass_AIK2Character_NoRegister()
	{
		return AIK2Character::StaticClass();
	}
	struct Z_Construct_UClass_AIK2Character_Statics
	{
...
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_FootIkComponent;
#if WITH_METADATA
	...
	UObject* (*const Z_Construct_UClass_AIK2Character_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_ACharacter,
		(UObject* (*)())Z_Construct_UPackage__Script_IK2,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AIK2Character_Statics::Class_MetaDataParams[] = {
		{ "HideCategories", "Navigation" },
		{ "IncludePath", "IK2Character.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AIK2Character_Statics::NewProp_FootIkComponent = { "FootIkComponent", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIK2Character, FootIkComponent), Z_Construct_UClass_UIkComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AIK2Character_Statics::NewProp_FootIkComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_AIK2Character_Statics::NewProp_FootIkComponent_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AIK2Character_Statics::NewProp_BaseLookUpRate_MetaData[] = {
		{ "Category", "Camera" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AIK2Character_Statics::NewProp_BaseLookUpRate = { "BaseLookUpRate", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIK2Character, BaseLookUpRate), METADATA_PARAMS(Z_Construct_UClass_AIK2Character_Statics::NewProp_BaseLookUpRate_MetaData, ARRAY_COUNT(Z_Construct_UClass_AIK2Character_Statics::NewProp_BaseLookUpRate_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AIK2Character_Statics::NewProp_BaseTurnRate_MetaData[] = {
		{ "Category", "Camera" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AIK2Character_Statics::NewProp_BaseTurnRate = { "BaseTurnRate", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIK2Character, BaseTurnRate), METADATA_PARAMS(Z_Construct_UClass_AIK2Character_Statics::NewProp_BaseTurnRate_MetaData, ARRAY_COUNT(Z_Construct_UClass_AIK2Character_Statics::NewProp_BaseTurnRate_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AIK2Character_Statics::NewProp_FollowCamera_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Camera" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AIK2Character_Statics::NewProp_FollowCamera = { "FollowCamera", nullptr, (EPropertyFlags)0x00400000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIK2Character, FollowCamera), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AIK2Character_Statics::NewProp_FollowCamera_MetaData, ARRAY_COUNT(Z_Construct_UClass_AIK2Character_Statics::NewProp_FollowCamera_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AIK2Character_Statics::NewProp_CameraBoom_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Camera" },
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AIK2Character_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AIK2Character_Statics::NewProp_FollowCamera,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AIK2Character_Statics::NewProp_CameraBoom,
	};
	const FCppClassTypeInfoStatic Z_Construct_UClass_AIK2Character_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<AIK2Character>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AIK2Character_Statics::ClassParams = {
		&AIK2Character::StaticClass,
		"Game",
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_AIK2Character_Statics::PropPointers,
		nullptr,
		ARRAY_COUNT(DependentSingletons),
		0,
		ARRAY_COUNT(Z_Construct_UClass_AIK2Character_Statics::PropPointers),
		0,
		0x008000A0u,
		METADATA_PARAMS(Z_Construct_UClass_AIK2Character_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AIK2Character_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_AIK2Character()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AIK2Character_Statics::ClassParams);
		}
		return OuterClass;
	}
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_AIK2Character(Z_Construct_UClass_AIK2Character, &AIK2Character::StaticClass, TEXT("/Script/IK2"), TEXT("AIK2Character"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(AIK2Character);
